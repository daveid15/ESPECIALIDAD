...
administrator_patterns = [
    ...
    path('list_user_active/<int:group_id>/', views.list_user_active, name='list_user_active'),     
    path('list_user_active/<int:group_id>/<int:page>/', views.list_user_active, name='list_user_active_with_page'),     
    path('list_user_block/<int:group_id>/', views.list_user_block, name='list_user_block'),     
    path('list_user_block/<int:group_id>/<int:page>/', views.list_user_block, name='list_user_block_with_page'),  
